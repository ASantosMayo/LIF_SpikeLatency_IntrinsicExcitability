...
/*
 * There are three scenarios, in which LIF_SL_IPModule can be loaded by NEST:
 *
...
mynest::LIF_SL_IPModule LIF_SL_IPmodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::LIF_SL_IPModule::LIF_SL_IPModule()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::LIF_SL_IPModule::name( void ) const
{
  return std::string( "LIF_SL_IP NEST Module" ); // Return name of the module
}

const std::string
mynest::LIF_SL_IPModule::commandstring( void ) const
{
  // Instruct the interpreter to load LIF_SL_IPmodule-init.sli
  return std::string( "(LIF_SL_IPmodule-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::LIF_SL_IPModule::init( SLIInterpreter* i )
{
  /* Register a neuron or device model.
     Give node type as template argument and the name as second argument.
  */
  nest::kernel().model_manager.register_node_model< lif_psc_alpha_sl_ip >(
    "lif_psc_alpha_sl_ip" );


} // LIF_SL_IPModule::init()
